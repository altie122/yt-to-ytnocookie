...
export default function Index() {
  return (
    <div className="container mx-auto">
      ...
      <h2>Allowed links:</h2>
      <ul>
        <li>Watch/Base Youtube:<br />https://youtube.com/watch?v=_____</li>
        <li>Share:<br />https://youtu.be/_________?si=_____</li>
        <li>Embed:<br />https://youtube.com/embed/_________?si=_____</li>
      </ul>
      <br />
      <h2>Examples:</h2>
      <ul>
        <li>Watch/Base Youtube:<br />https://youtube.com/watch?v=87TdQAGmeOA</li>
        <li>Share:<br />https://youtu.be/87TdQAGmeOA?si=VNHziLtQTP_2Nv2Z</li>
        <li>Embed:<br />https://youtube.com/embed/87TdQAGmeOA?si=VNHziLtQTP_2Nv2Z</li>
      </ul>
    </div>
  );
}
