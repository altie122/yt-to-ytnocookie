  ...
  return (
    <Accordion type="single" collapsible>
      <AccordionItem value="item-1">
        ...
        <Separator />
        Path: https://yt-to-ytnocookie.xyz/api/full
        <br />
        Usage: https://yt-to-ytnocookie.xyz/api/full?url={'{Youtube URL}'}
        <br />
        Response:{'{"IsYT":true,"URL":"{Youtube Nocookie URL}","ID":"{Youtube ID}"}'} OR a 400 error will be served
        <Separator />
        Example: https://yt-to-ytnocookie.xyz/api/full?url=https://www.youtube.com/watch?v=87TdQAGmeOA
        <br />
      ...
      <AccordionItem value="item-2">
        ...
        <Separator />
        Path: https://yt-to-ytnocookie.xyz/api/isyt
        <br />
        Usage: https://yt-to-ytnocookie.xyz/api/isyt?url={'{Youtube URL}'}
        <br />
        Response:{'{"IsYT":{true/false}}'}
        <Separator />
        Example: https://yt-to-ytnocookie.xyz/api/isyt?url=https://www.youtube.com/watch?v=87TdQAGmeOA
        <br />
      ...
      <AccordionItem value="item-3">
        ...
        <Separator />
        Path: https://yt-to-ytnocookie.xyz/api/ytid
        <br />
        Usage: https://yt-to-ytnocookie.xyz/api/ytid?url={'{Youtube URL}'}
        <br />
        Response:{'{"ID":"{Youtube ID}"}'} OR a 400 error will be served
        <Separator />
        Example: https://yt-to-ytnocookie.xyz/api/ytid?url=https://www.youtube.com/watch?v=87TdQAGmeOA
        <br />
      ...
      <AccordionItem value="item-4">
        ...
        <Separator />
        Path: https://yt-to-ytnocookie.xyz/api/yttoytnocookie
        <br />
        Usage: https://yt-to-ytnocookie.xyz/api/yttoytnocookie?url={'{Youtube URL}'}
        <br />
        Response:{'{"URL":"{Youtube Nocookie URL}"}'} OR a 400 error will be served
        <Separator />
        Example: https://yt-to-ytnocookie.xyz/api/yttoytnocookie?url=https://www.youtube.com/watch?v=87TdQAGmeOA
        <br />
